...
## Bookstore - [HTML/CSS & REACT Math Magician Project](https://github.com/microverseinc/curriculum-javascript/blob/main/books/m2_plain_js_classes_v1_1.md)
### Features Added:
- Create a Library ui with React-js.
- Create all functionality a bookstore have with react state and props.
- Create a (SPA) single page app but behave like multiple page app.
- User can add a book to the bookstore.
- User can delete a book from the bookstore.
...
> cd my-folder
> git clone https://github.com/jubaer919/bookstore.git
...
Bookstore: a complete website [this](https://github.com/microverseinc/curriculum-javascript/blob/main/books/m4_full_website_v1_1.md) will be added.
